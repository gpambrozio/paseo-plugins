 ...
 *
 * This is the port of FirstMate's operating contract — the part of that distro
 * that is behaviour rather than plumbing. Everything it did with tmux panes,
 * treehouse worktrees, a bash watcher and status files is done here with
  ...
  return fill(TEMPLATE, {
    ...
    crewProviderRule:
      crewProvider === ""
        ...
        : `\`${crewProvider}\`, the captain's choice for the crew, unless the captain says otherwise for this task;`,
    crewModeRule:
      crewModeId === ""
...
export const CAPTAIN_TEMPLATE = `# Standing orders

The captain's standing orders for the first mate. Anything written here outranks the charter in
...
Modes: direct-PR, local-only, reviewed-PR. \`+yolo\` lets the first mate merge green work itself.
`;

export const LEARNINGS_TEMPLATE = `# Learnings
