/**
 * Where this plugin keeps its own files: `$PASEO_HOME/plugin-data/github-board/`.
 *
 * They used to live in `$PASEO_HOME/plugins/github-board/`, which is also where Paseo
...
export const PLUGIN_ID = "github-board";
